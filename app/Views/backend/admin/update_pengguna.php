                ...
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            ...
                            <div class="mt-2">
                                <a href="<?php echo site_url('mengelola_pengguna') ?>">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="<?php echo site_url('mengelola_pengguna') ?>">Mengelola Pengguna</a></li>
                ...
                <div class="container-fluid">
                    <div class="card card-dark">
                        ...
                        <div class="card-body">
                            ...
                            <form action="<?php echo site_url('update_pengguna/process/' . $user->pengguna_id) ?>" method="post">
                                <input type="hidden" name="_method" value="PUT">
                                <div class="card-body">
                                    <div class="form-group">
                                        <label for="username">Username</label>
                                        <input type="text" class="form-control" id="username" name="username" value="<?php echo $user->username ?>" autocomplete="nope" >
                                    </div>
                                    <div class="form-group">
                                        <label for="password">Password</label>
                                        <input type="password" class="form-control" id="password" name="password" value="<?php echo $user->password ?>" autocomplete="nope" >
