                ...
                <div class="container-fluid">
                    <div class="card card-dark">
                        ...
                        <div class="card-body">
                            ...
                            <form action="<?php echo site_url('process/tambah_pengguna') ?>" method="post">
                                <div class="card-body">
                                    <div class="form-group">
                                        <label for="username">Username</label>
                                        <input type="text" class="form-control" id="username" name="username" value="" autocomplete="nope" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="password">Password</label>
                                        <input type="password" class="form-control" id="password" name="password" value="" autocomplete="nope" required>
                                    </div>
                                    <div class="form-group">
